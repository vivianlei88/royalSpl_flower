...
- **Endpoint**: `GET/POST https://app-des7uh9iwsu9-api-Q9KWZ8R7Qv09.gateway.appmedo.com/v3/article`
...
async function callWebpageContentExtract(
  ...
  const response = await fetch(
    `https://app-des7uh9iwsu9-api-Q9KWZ8R7Qv09.gateway.appmedo.com/v3/article?${params.toString()}`,
    {
