...
|-------|-------|
| Method | `POST` |
| URL | `https://app-des7uh9iwsu9-api-GYX1lzGw0DQa.gateway.appmedo.com/image-generation/task` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-des7uh9iwsu9-api-GYX1lzGw0DQa.gateway.appmedo.com/image-generation/task",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
