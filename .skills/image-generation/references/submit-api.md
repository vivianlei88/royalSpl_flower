...
|-------|-------|
| Method | `POST` |
| URL | `https://app-des7uh9iwsu9-api-zYkZzKQJrBdL.gateway.appmedo.com/image-generation/submit` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-des7uh9iwsu9-api-zYkZzKQJrBdL.gateway.appmedo.com/image-generation/submit",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
