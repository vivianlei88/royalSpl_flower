...
| Item | Details |
|------|---------|
| Endpoint | `POST https://api-DYJwnoM46d6a@app-des7uh9iwsu9-api-DYJwnoM46d6a.gateway.appmedo.com` |
...
async function queryVideoStatus(videoId: string): Promise<VideoStatusResponse> {
  const response = await fetch(
    "https://api-DYJwnoM46d6a@app-des7uh9iwsu9-api-DYJwnoM46d6a.gateway.appmedo.com",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
