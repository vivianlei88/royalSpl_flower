...
**Endpoint:** `GET https://app-des7uh9iwsu9-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}`
...
async function getNewsByUuid(uuid: string): Promise<NewsArticle> {
  const response = await fetch(
    `https://app-des7uh9iwsu9-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/${encodeURIComponent(uuid)}`,
    {
      method: "GET",
      headers: {
