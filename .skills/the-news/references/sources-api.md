...
**Endpoint:** `GET https://app-des7uh9iwsu9-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources`
...
async function getSources(params: SourcesParams = {}): Promise<SourcesResponse> {
  ...
  const response = await fetch(
    `https://app-des7uh9iwsu9-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
