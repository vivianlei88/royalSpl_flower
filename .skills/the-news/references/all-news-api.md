...
**Endpoint:** `GET https://app-des7uh9iwsu9-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all`
...
async function getAllNews(params: AllNewsParams = {}): Promise<AllNewsResponse> {
  ...
  const response = await fetch(
    `https://app-des7uh9iwsu9-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
