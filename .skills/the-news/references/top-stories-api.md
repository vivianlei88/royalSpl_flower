...
**Endpoint:** `GET https://app-des7uh9iwsu9-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top`
...
async function getTopStories(params: TopStoriesParams = {}): Promise<TopStoriesResponse> {
  ...
  const response = await fetch(
    `https://app-des7uh9iwsu9-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
