...
**Endpoint:** `GET https://app-des7uh9iwsu9-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}`
...
async function getSimilarNews(uuid: string, params: SimilarNewsParams = {}): Promise<SimilarNewsResponse> {
  ...
  const response = await fetch(
    `https://app-des7uh9iwsu9-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/${encodeURIComponent(uuid)}${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
