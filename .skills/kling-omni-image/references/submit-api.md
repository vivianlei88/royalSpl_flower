...
**Endpoint:** `POST https://app-des7uh9iwsu9-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image`
...
async function submitOmniImageTask(params: SubmitParams): Promise<SubmitResult> {
  ...
  const response = await fetch(
    "https://app-des7uh9iwsu9-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image",
    {
      method: "POST",
      headers: {
