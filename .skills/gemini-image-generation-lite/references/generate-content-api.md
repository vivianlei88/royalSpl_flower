...
|------|-------|
| Method | `POST` |
| Endpoint | `https://app-des7uh9iwsu9-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent` |
...
async function generateOrEditImage(
  ...
  const response = await fetch(
    "https://app-des7uh9iwsu9-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
