...
| Property | Value |
|----------|-------|
| **Endpoint** | `GET https://app-des7uh9iwsu9-api-rLobzpqX85m9.gateway.appmedo.com/v1/videos/image2video/{id}` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-des7uh9iwsu9-api-rLobzpqX85m9.gateway.appmedo.com/v1/videos/image2video/${taskId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
